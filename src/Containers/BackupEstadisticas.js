    ...
    render() {
        ...
        return (
            <div>
                ...
                <div style={{display:"flex", border:"1px solid gray", padding:"10px", boxShadow: "5px 10px 8px #888888",  width: "35em",
                ...
                <div style={
                    {
                        ...
                        marginRight:"50px",
                        borderRadius: "8px",
                        backgroundColor: "#FFC685"
                    }
                }>Información sobre dimensión</div>
                <Footer></Footer>
            </div>
